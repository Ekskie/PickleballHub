...
## Corpus Check
- 48 files · ~195,635 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 617 nodes · 902 edges · 83 communities (39 shown, 44 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 22 edges (avg confidence: 0.91)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `a2785835`
...
Cohesion: 0.10
Nodes (33): add_court(), add_facility(), add_staff(), _advance_bracket(), api_courts_by_facility(), bracket_generate(), change_event_status(), courts() (+25 more)

### Community 4 - "Community 4"
Cohesion: 0.06
Nodes (53): create_app(), adjust_profile_stats(), elo_to_dupr(), ensure_initial_history(), get_initial_rating(), init_player_rating(), Recalculate ratings for players of a matchmaking lobby (Team 1 vs Team 2)., Recalculate ratings for players of a matchmaking lobby (Team 1 vs Team 2). (+45 more)
